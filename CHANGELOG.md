...
### Changed
+ AL_USDMaya now compiles and works with USD 0.19.7 and 0.19.10
+ Moved codebase onto shared Autodesk maya-usd
+ Export Animation for dynamic attributes

### Fixed
+ Transform values were being incorrectly written into the session layer on selection
+ Issue where the translate and scale tools could reset their transformation values

## v0.34.6 (2019-09-19)

### Fixed
+ Variant changed listener now only processes notices sent from the prosy shape stage
